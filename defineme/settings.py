"""
Django settings for defineme project.
...
SECRET_KEY = '^k4n$4)p&5jntk)vyqfeowncnqza91!55j7@3$8+j=p^dl0l#a'
...
WSGI_APPLICATION = 'defineme.wsgi.application'
